        ...
        <div class="p-4 mt-10">
            ...
            <div class="pt-4">
                <div
                    ...
                    <!-- Boton de crear -->
                    <a href="{{ route('colors.create') }}" class="inline-block text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                        Agregar color
                    </a>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4 w-3">
                                            <form action="{{ route('colors.destroy', $color) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button href="{{ route('categories.edit', $color) }}"
