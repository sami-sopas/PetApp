<x-admin-layout>
    <div class="p-4 sm:ml-64">
        <div class="p-4 mt-10">
            <span>{{ Breadcrumbs::render('colors-edit',$color) }}</span>
                ...
                <div
                    ...
                    @if (session('info'))
                        <div id="alert-border-3" class="flex items-center p-4 mb-4 text-green-800 border-t-4 border-green-300 bg-green-50 dark:text-green-400 dark:bg-gray-800 dark:border-green-800 rounded-sm" role="alert">
                            ...
                            {{ session('info')}} <a href="{{ route('colors.index') }}" class="font-semibold underline hover:no-underline">Regresar al menu</a>
                            </div>
                    ...
                    <form action="{{ route('colors.update',$color) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" placeholder="Roedor" name="name" required value="{{ $color->name }}"
