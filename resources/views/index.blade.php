<x-app-layout>
    <div>
        <header data-w-id="bea9b7ed-f748-980a-924e-d39fafb4bf59" class="homepage-header">
            <div class="container-1440 full-width">
                ...
                <div class="home-header-images-grid"><img
                        ...
                        width="322" loading="eager" data-w-id="0e008f32-1617-f27a-7abd-760eefcc8735"
                        alt="Girl cuddling grey kitten" id="w-node-_0e008f32-1617-f27a-7abd-760eefcc8735-9000696c"
                        class="header-photo-left-1" /><img
                        ...
                        alt="Woman with adopted Dalmatian dog "
                        id="w-node-c9037e5e-4f1a-7eef-d8b1-a339fe0c2294-9000696c" class="header-photo-center" /><img
                        ...
                        alt="Man carrying his terrier dog under one arm"
                        id="w-node-e0566be4-826c-378c-0d53-f02832fa701a-9000696c" class="header-photo-right-1" /><img
                        ...
                        alt="Woman sitting on porch with ginger cat"
                        id="w-node-_70a28926-4468-4379-149d-cae994cfa78d-9000696c" class="header-photo-right-2" /></div>
            </div>
                ...
                <div class="_3-column-grid big-buttons"><a href="{{ route('adopt-dog.index') }}"
                            ...
                            <div class="content-padding">
                                <div class="big-lottie-icons-wrapper">
                                    <div data-is-ix2-target="1" class="big-lottie-icon"
                                        data-w-id="8151a4d6-8800-7c83-5fe5-cd75d290be22" data-animation-type="lottie"
                        ...
                        <div class="lottie-animation">
                            <div class="content-padding">
                                <div class="big-lottie-icons-wrapper">
                                    <div data-is-ix2-target="1" class="big-lottie-icon"
                                        data-w-id="34fffe70-9046-9bd8-bc5b-a3a1c933b5ce" data-animation-type="lottie"
                        ...
                        <div class="lottie-animation">
                            <div class="content-padding">
                                <div class="big-lottie-icons-wrapper">
                                    <div data-is-ix2-target="1" class="big-lottie-icon"
                                        data-w-id="884331d0-4614-cbc7-351f-07b5723ad4d6" data-animation-type="lottie"
        ...
        <section class="section wide mt-6">
            ...
            <div>
                <div id="w-node-aee8e3bd-823d-383f-7c30-f860acc22559-9000696c" class="flex-horizontal right-notes">
                    <img src="https://uploads-ssl.webflow.com/5f4f91ff23802a48574383ea/5f4f91ff23802a353b438471_Adoptable_Arrow Style 2_pink.svg"
                        width="150" alt="" class="rotate-arrow" />
                    <h2 class="handwriting margins">...y un poco de informacion</h2>
                </div>
            </div>
        </section>
        ...
        <section class="section wide">
            ...
            <div class="slider-container">
                <div data-delay="6000" data-animation="slide" class="testimonial-slider w-slider"
                    ...
                    data-autoplay-limit="0" data-nav-spacing="6" data-duration="500" data-infinite="true">
                    ...
                    <div class="left-arrow hide-on-mobile w-slider-arrow-left">
                        <div class="arrow-padding"><img
                                ...
                                id="w-node-d2bed5c3-b2bf-15c6-19d2-1aab90f83ac9-9000696c" alt="" /></div>
                    </div>
                    <div class="right-arrow hide-on-mobile w-slider-arrow-right">
                        <div class="arrow-padding"><img
                                ...
                                width="24" loading="lazy"
                                id="w-node-d2bed5c3-b2bf-15c6-19d2-1aab90f83acb-9000696c" alt="" /></div>
                    </div>
